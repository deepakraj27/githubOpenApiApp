...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if UserDefaults.standard.value(forKey: "loginData") != nil{
            let homeScreen = MyStoryboard.Main.instance.instantiateViewController(withIdentifier: RepositoryStatusViewController.storyboardID) as! RepositoryStatusViewController
